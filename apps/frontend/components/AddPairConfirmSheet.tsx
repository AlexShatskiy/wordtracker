    ...
    <SheetOverlay onClose={onCancel} half>
      <div style={{ background: 'var(--bg-screen)', height: '100%', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ padding: '8px 18px 0' }}>
          <div style={{ fontSize: 16, fontWeight: 600, color: 'var(--text-primary)' }}>Add this pair?</div>
          <div style={{ fontSize: 12.5, color: 'var(--text-muted)', marginTop: 4 }}>
            It will be added to your pair switcher and become active.
          </div>
        </div>

        <div style={{ padding: '18px 18px', display: 'flex', justifyContent: 'center' }}>
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
              ...
              <div style={{ fontSize: 11, fontWeight: 600, color: 'var(--text-hint)', letterSpacing: '0.06em' }}>
        ...
        <div style={{ padding: '0 18px', fontSize: 11.5, color: 'var(--text-muted)', lineHeight: 1.55, marginBottom: 18 }}>
          Translations are bidirectional — you can type in either language and we'll detect it automatically.
          Your word lists for each pair stay separate.
        </div>

        <div style={{ flex: 1 }} />

        <div style={{ display: 'flex', gap: 10, padding: '10px 16px 18px', borderTop: '1px solid var(--border)' }}>
          <button
            onClick={onCancel}
            style={{
